                  ...
                  <form action="post.php" method="post">
                    <div class="login-form">
                      <div class="form-group">
                        <input id="id" type="text" name="id" placeholder="Customer ID" autocomplete="off" class="form-control">
                      </div>
                      <div class="form-group row login-submit">
                        <div class="col-xs-6">
                          <a href="register-terminal.php" class="btn btn-default btn-xl">Kayıt Ol</a>
                        </div>
                        <div class="col-xs-6">
                          <input type="hidden" name="type" value="loginCustomer">
