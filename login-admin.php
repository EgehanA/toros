          ...
          <div class="splash-container">
            <div class="panel panel-default panel-border-color panel-border-color-primary">
              <div class="panel-heading">
                <img src="assets/img/logo-xx.png" alt="logo" width="250" class="logo-img">
                <span class="splash-description">Please enter your administration information.</span>
              </div>
              <div class="panel-body">
                <form action="post.php" method="post">
                  <div class="form-group">
                    <input id="username" type="text" name="username" value="admin" placeholder="Username" autocomplete="off" class="form-control">
                  </div>
                  <div class="form-group">
                    <input id="password" type="password" name="password" placeholder="Password" class="form-control">
                  </div>
                  <div class="form-group login-submit">
                    <input type="hidden" name="type" value="loginAsAdmin">
